...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2016 at 02:50 PM
...
INSERT INTO `system_accounts` (`acc_id`, `client_id`, `user_name`, `password`, `type`) VALUES
(1, NULL, 'nullpointer', '15963', 'admin'),
(2, 15, 'NULLVin', '09234567892', 'client'),
(3, NULL, 'NULLBravo', '09267461134', 'client'),
(5, NULL, 'NULLSalud', '09283434982', 'client'),
(6, NULL, 'NULLWiws', '09283453789', 'client');
