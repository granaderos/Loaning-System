<html>
	...
	<body>
		<div id = "divMainContainer">
			...
			<div id = "divContent"></div> <!-- End of div content -->
			...
			<div id = "homeContent">
				<!--<form onsubmit = "return false" method = "POST" id = "form_client_data">-->
					<table>
						<tr>
							<td>
								<table>
							...
							<td>
								<table>
									...
									<tr>
										<td>Loan Type</td>
										<td>:</td>
										<td><select id = "type"><option value = "Cash">Cash</option>
									...
									<tr>
										<td>title</td>
										<td>:</td>
										<td id = "propertyTitleTD"><input type = "text" id = "loan_title"></td>
									</tr>
									<tr>
									...
									<input type = "hidden" id="date_due" />
									<tr>
										<td>remarks</td>
										<td>:</td>
										<td><input type = "text" placeholder = "optional" id = "remarks"></td>
									</tr>
								</table>
							</td>
						</tr>
					...
					<div id = "homeActionClientDiv">
					</div> <!-- end of homeActionClientDiv -->
				<!-- </form> -->	
				...
				<div id = "updateClientForm">
					...
					<table>
						<tr>
							<td>First name</td>
							<td>:</td>
							<td><input type = "text" id = "new_firstname" name = "firstname"></td>
						</tr>
						<tr>
							<td>Last name</td>
							<td>:</td>
						...
						<tr>
							<td>Job</td>
							<td>:</td>
							<td><input type = "text" id = "new_job"></td>
						</tr>
						<tr>
							<td>Income/Month</td>
							<td>:</td>
							<td><select id = "new_income">
							<option>P10,000 below</option>
							<option>P10,000 - P50,000</option>
							<option>P50,000 - P100,000</option>
							<option>P100,000 - P200,000</option>
					...
					<button id = "cmd_saveClientInfo" class = "btn btn-warning" onclick = "saveChangesClientInfo()">save</button>
					<button id = "cmd_cancelClientInfo" class = "btn btn-danger" onclick = "closeUpdateClientForm()">cancel</button>
				</div> <!--end of updateClientForm -->
			...
			<div id = "propertiesContent">
				...
				<table>
					<tr>
						<td><table id = "properties_list" class = "table tbl-hover"></table></td>
						<td>
							<table id = "tbl_addProp">
								<tr><td colspan = 3><h3>Add Property here:</h3></td></tr>
								<tr>
									<td>Type</td>
									<td>:</td>
									<td><select id = "propType"><option value = "House">House & Lot</option><option value = "Car">Car</option></select></td>
								</tr>
								<tr>
									<td>Name</td>
									<td>:</td>
								...
								<tr>
									<td>Price</td>
									<td>:</td>
									<td><input type = "text" id = "propPrice" /></td>
								</tr>
								<tr>
									<td>Location</td>
									<td>:</td>
									<td><input type = "text" placeholder = "optional" id = "propLocation" /></td>
								</tr>
								<tr>
									<td>
										<button onclick = 'addProperty()' id = "cmd_add_property" class = "btn btn-primary">ADD</button>
									</td>
									<td>
										<button onclick = 'saveProp()' id = "cmd_save_property" class = 'btn btn-primary' disabled>SAVE</button>&nbsp;
									</td>
									<td>
